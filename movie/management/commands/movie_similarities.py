...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        movie1 = Movie.objects.get(title="Inception")
        movie2 = Movie.objects.get(title="Interestellar")
